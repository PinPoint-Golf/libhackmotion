 ...
 * reply, the second sensor-map byte, the 64-byte calibration payload, two
 * configuration bits — and §6.6's burst trigger and §10's unexplained drift are
 * open.  When any of those is settled a byte-level recording can be RE-DECODED
